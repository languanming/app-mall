// 此版本不支持小程序使用插件
!function (n, t) {
  "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : n.Alpha = t();
}(this, function () {
  console.log('ald');
  function n() {
  ...
  function e() {
    "function" == typeof gn && "" === G && gn().then(function (n) {
      28 === n.length && (G = n, wx.setStorageSync("alphaStat_op", n));
    });
  }
  ...
  function r(n) {
    j = S(), W = n, ln = n.scene, this.alphacloud_ald = new o(this);
  }

  function i(n) {
    e();
    var t;
    t = n.scene != ln, ln = n.scene, V = 0, W = n, F = n.query.alpha_share_src, X = n.query.alphasrc || "", Y = n.query.alpha_share_src, fn || ($ = !1), fn = !1, (0 !== Q && Date.now() - Q > 3e4 || t) && (hn || (T = S(), N = Date.now(), wn = 0)), 0 !== Q && Date.now() - Q < 3e4 && (rn = !0), n.query.alpha_share_src && "1044" == n.scene && n.shareTicket ? wx.getShareInfo({
      shareTicket: n.shareTicket,
      success: function (n) {
        nn = n, A("event", "alpha_share_click", JSON.stringify(n));
      },
    }) : n.query.alpha_share_src && A("event", "alpha_share_click", 1), "" === tn && wx.getSetting({
      withCredentials: !0,
      success: function (n) {
  ...
  function a(n) {
    Z++ , A("event", "alpha_error_message", n);
    console.log('报错信息总数：：' + Z);
  }
  ...
  function c() {
    ...
    console.log('页面打开的时候' + this.route)
  }
  ...
  // 拉下刷新触发
  function l() {
    A("event", "alpha_pulldownrefresh", 1);
  }

  // 触底的时候触发
  function p() {
    A("event", "alpha_reachbottom", 1);
  }
  ...
  function d(n) {
    hn = !0;
    var t = m(n.path), e = {};
    for (var o in W.query) "alpha_share_src" === o && (e[o] = W.query[o]);
    var r = "";
    if (r = n.path.indexOf("?") == -1 ? n.path + "?" : n.path.substr(0, n.path.indexOf("?")) + "?", "" !== t) for (var o in t) e[o] = t[o];
    e.alpha_share_src ? e.alpha_share_src.indexOf(z) == -1 && e.alpha_share_src.length < 200 && (e.alpha_share_src = e.alpha_share_src + "," + z) : e.alpha_share_src = z;
    for (var i in e) i.indexOf("alpha") == -1 && (r += i + "=" + e[i] + "&");
    return n.path = r + "alpha_share_src=" + e.alpha_share_src, A("event", "alpha_share_status", n), n;
  }
  ...
  function g(n) {
    function t() {
      return new Promise(function (t, e) {
        var o = { AlphaStat: "MiniApp-Stat", se: J || "", op: G || "", img: K };
        "" === E || (o.ai = E), wx.request({
          url: "https://" + U + ".aldwx.com/d.html",
          // url: "http://172.16.99.238:9988/index.html",
          // url: 'http://121.199.36.121',
          // url: 'https://log.alphadigtal.com',
          data: n,
          header: o,
          method: "GET",
          success: function (n) {
  ...
  var H = require("./alpha-cloud-ald-conf");
  ...
  var C = "7.3.2", U = "log", b = "wx", E = function () {
    ...
    var n = "";
    try {
      n = wx.getStorageSync("alphaStat_op");
    } catch (n) {
    }
    return n;
  }(), K = "", V = 0, W = "", $ = "", z = function () {
    var n = "";
    try {
      n = wx.getStorageSync("alphaStat_uuid");
    } catch (t) {
    ...
    if (n) $ = !1; else {
      n = w();
      try {
        wx.setStorageSync("alphaStat_uuid", n), $ = !0;
      } catch (n) {
        wx.setStorageSync("alphaStat_uuid", "uuid_getStorageSync");
      }
    }
    return n;
  ...
  wx.getNetworkType({
    ...
    o.prototype.sendSession = function (n) {
      ...
      G = n, wx.setStorageSync("alphaStat_op", n);
      var t = v();
